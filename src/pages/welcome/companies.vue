<template>
    <div class="font-inter">
        ...
        <div
            ...
            id="troubles-box"
        >
            <img :src=complex alt="Complex" id="complex-images" />
        ...
        >
            ...
            <img :src=costumers alt="Costumers" id="costumers-image" />
        </div>
        <div>
            ...
            <div class="flex justify-stretch align-center w-full my-12 px-44 gap-8">
                <div
                    class="p-5 flex flex-column align-center text-center"
            ...
            <div class="justify-center flex flex-column align-center">
                <div class="achievements-image">
                    <img :src="pc" alt="Welcome pc" class="relative -mb-2">
                </div>
                <div
                    class="flex flex-row justify-center bg-background-gray
                    w-full h-32 align-center"
                >
                    <div class="flex flex-row justify-center align-center gap-8 mx-24">
                    <div>
                        <div id="ach-1">
                            <h2
                                class="font-semibold text-3xl text-grays-1"
                                style="text-shadow: 0px 1px 2px #0000004D;"
                            >
                                A partir de solo
                                <span class="text-greens-3">USD$1</span>
                            </h2>
                            <p class="text-sm text-blacks-1">
                    ...
                    <p id="text-grays-1">
                        Y
                        <span class="text-greens-2 underline">acceder a certificaciones</span>
        ...
        <div class="flex flex-row justify-center align-center px-36 gap-2 mt-8 mb-4">
            <img :src=stats alt="Stats" id="stats-image" />
            <div class="px-16 text-grays-1">
                <h3 class="text-grays-1 text-xl mb-8 font-bold">Registro 100% transparente</h3>
        ...
        <div class="flex flex-row justify-center align-center px-36 gap-2 mt-8 mb-4">
            ...
            <div class="px-16 text-grays-1">
                ...
                <p class="text-grays-2 text-sm mb-4">
        ...
        <div class="flex flex-row justify-center py-8">
            <button class="bg-greens-1 w-32 text-xs py-2 px-2 font-bold" id="start-btn">
                Compra i-RECS
            </button>
        </div>
...
export default {
  ...
  components: {
    HomeNavbar, ContactUs, WelcomeFooter, Introduction, WelcomeBox,
  },
  methods: {
